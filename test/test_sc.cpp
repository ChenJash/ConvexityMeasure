...
#include <vector>
#include <ctime>
#include "../convexity/measureSC.h"

using namespace std;

// g++ test_sc.cpp -std=c++11
...
int main() {
    ...
    polygon.push_back({-1,1});
    polygon.push_back({-1,0});
    cout << checkPolygonConvexBySC(polygon, vector<PointList>())[0] << endl;
    // return 0;
    ...
    auto start = clock();
    auto res = checkConvexForSC(grid_asses, cluster_labels);
